...
export function generateMock(schema: Schema, source: string, lang: MockLang): string {  // refactored buffer call  // refactored context call  // refactored state call  // refactored lazy call
  switch (lang) {
...
export function applyPub(input) {
